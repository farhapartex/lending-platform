...
//
// Solidity: function burn(address holder, uint256 amount) returns()
func (_MockERC20 *MockERC20Transactor) Burn(opts *bind.TransactOpts, holder common.Address, amount *big.Int) (*types.Transaction, error) {
	return _MockERC20.contract.Transact(opts, "burn", holder, amount)
}

// Burn is a paid mutator transaction binding the contract method 0x9dc29fac.
//
// Solidity: function burn(address holder, uint256 amount) returns()
func (_MockERC20 *MockERC20Session) Burn(holder common.Address, amount *big.Int) (*types.Transaction, error) {
	return _MockERC20.Contract.Burn(&_MockERC20.TransactOpts, holder, amount)
}

// Burn is a paid mutator transaction binding the contract method 0x9dc29fac.
//
// Solidity: function burn(address holder, uint256 amount) returns()
func (_MockERC20 *MockERC20TransactorSession) Burn(holder common.Address, amount *big.Int) (*types.Transaction, error) {
	return _MockERC20.Contract.Burn(&_MockERC20.TransactOpts, holder, amount)
}
...
func (_MockERC20 *MockERC20Transactor) Mint(opts *bind.TransactOpts, receiver common.Address, amount *big.Int) (*types.Transaction, error) {
	return _MockERC20.contract.Transact(opts, "mint", receiver, amount)
}

// Mint is a paid mutator transaction binding the contract method 0x40c10f19.
//
// Solidity: function mint(address receiver, uint256 amount) returns()
func (_MockERC20 *MockERC20Session) Mint(receiver common.Address, amount *big.Int) (*types.Transaction, error) {
	return _MockERC20.Contract.Mint(&_MockERC20.TransactOpts, receiver, amount)
}

// Mint is a paid mutator transaction binding the contract method 0x40c10f19.
//
// Solidity: function mint(address receiver, uint256 amount) returns()
func (_MockERC20 *MockERC20TransactorSession) Mint(receiver common.Address, amount *big.Int) (*types.Transaction, error) {
	return _MockERC20.Contract.Mint(&_MockERC20.TransactOpts, receiver, amount)
}
